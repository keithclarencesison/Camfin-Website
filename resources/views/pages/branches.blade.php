<x-layouts.app>
    ...
    <div class="branches-container flex flex-wrap justify-around">
        <div class="branches-info flex flex-col m-5">
            ...
            <p>📞 <span class="font-bold">Mobile: </span> (+63)9 499 939 304 </p>
            <p>📩 <span class="font-bold">Email Address: </span> camfinlending@sample.com</p>
            <p>☎️ <span class="font-bold">Telephone: </span> (02) 8376 6121 - 22</p>
            <br>
        ...
        <div class="flex flex-col gap-10 mb-20 max-xl:my-20 w-auto wrap shrink max-sm:gap-0">
            <img src="/images/map-direction.png" alt="" class="mr-5 ml-5">
            <div class="shrink m-5">
