<x-layouts.app>
    ...
    <div class="about-us-front bg-[#538FD6]/20  flex flex-wrap gap-15 justify-center shrink max-lg:gap-5">
        ...
        <div class="relative w-[600px] mt-10">
            <img src="images/about-us-group.png" alt="" class="relative top-0 left-0 z-10">
        </div>
    </div>

    <div class="our-story-section my-50 flex flex-col justify-center gap-5">
        <h1 class="text-center text-6xl font-bold">Our Story</h1>
        <p class="text-center w-1/2 self-center text-lg">Camfin lending, Inc. was established in 2008 by Filipino investors who have gained experience in financial industries.
